...
const Ontheway = () => {
    ...
    return (
        <div className='otw-home'>
            <h1>Update the on the way order here</h1>
            ...
            <div>
                <select onChange={e => setStatus(e.target.value)}>
                    ...
                    <option key={1} value='your order has been delivered successfully'>your order has been delivered successfully</option>
                </select>
            </div>
            <p>{status}</p>
